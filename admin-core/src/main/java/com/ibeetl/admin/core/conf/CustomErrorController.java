...
import com.ibeetl.admin.core.exception.BizExceptionEnum;
import com.ibeetl.admin.core.exception.GlobalException;
	...
	public ModelAndView getErrorPath(HttpServletRequest request, HttpServletResponse response) {
		...
		if(!isJsonRequest(request)){
			...
			if(  request.getAttribute("session") == null){
				...
				String userCode = (String) RequestContextHolder.getRequestAttributes().getAttribute("userCode",1);
