...
//    String appName;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new SessionInterceptor(httpRequestLocal, this)).excludePathPatterns("/image/*");
        registry.addInterceptor(new SessionInterceptor(httpRequestLocal, this)).excludePathPatterns("/images/*");
        registry.addInterceptor(new SessionInterceptor(httpRequestLocal, this)).excludePathPatterns("/app/smsInfo/sms/getCode.json");
