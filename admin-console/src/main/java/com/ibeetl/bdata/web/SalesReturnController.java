...
import com.ibeetl.bdata.service.*;
import com.ibeetl.bdata.web.query.*;
...
public class SalesReturnController{
    ...
    @ResponseBody
    public ModelAndView edit(String returnId) {
    ...
    @Function("salesReturn.query")
    @ResponseBody
    public JsonResult<SalesReturn>queryInfo(String returnId) {
        SalesReturn salesReturn = salesReturnService.queryById( returnId);
    ...
    public JsonResult<String> export(HttpServletResponse response,SalesReturnQuery condtion) {
         ...
         */
        String excelTemplate ="excelTemplates/cms/salesReturn/你的excel模板文件名字.xls";
        ...
        try(InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream(excelTemplate)) {
            ...
            FileItem item = fileService.createFileTemp("SalesReturn_"+DateUtil.now("yyyyMMddHHmmss")+".xls");
